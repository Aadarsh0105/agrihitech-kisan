...
import { TranslationInput } from '../../components/admin/shared/TranslationInput';
...
import { brands, categories, products, productAttributes, subCategories } from '../../data/admin/catalogue';
import { availabilityOptions, statusOptions, newId } from '../../config/admin/options';
import { slugify } from '../../utils/admin/format';
import { t } from '../../utils/admin/i18n';
import type { Product, Translated } from '../../types/admin';
